...
using DelimitedFiles, DataFrames, CategoricalArrays, Missings, Plots, Statistics, Distances, StatsPlots, Gadfly, Compose, ColorSchemes, Distributions, CSV
...
begin
	...
	named_switzerland[!, 4:5] = apply(named_switzerland[!,4:5], DeclareMissings(; values=(0)))
end;
...
begin
	...
	named_hungarian[!, 4:5] = apply(named_hungarian[!,4:5], DeclareMissings(; values=(0)))
end;
...
begin
	...
	named_va[!, 4:5] = apply(named_va[!,4:5], DeclareMissings(; values=(0)))
end;
...
# ╔═╡ f2e695aa-4e1d-43d5-9343-275acd15476c
begin 
	temp_swiss = DataFrame(vcat(named_switzerland, named_va, named_hungarian))
end;

# ╔═╡ 6d614c21-d4f1-42d0-b8f1-33b449e7a32c
begin
	imputed_va = Impute.srs(named_va);
	imputed_swiss = Impute.srs(temp_swiss);
	imputed_swiss = imputed_swiss[1:123,:]
...
# ╔═╡ cc6047ba-6c42-4e56-bcf7-0a60a3243d89
begin 
	CSV.write("imputed_hungarian.csv", imputed_hungarian)
	CSV.write("imputed_swiss.csv", imputed_swiss)
	CSV.write("imputed_va.csv", imputed_va)
end
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "ba1befb6c73a5fe214d6649bb44ef4f988d128c7"
