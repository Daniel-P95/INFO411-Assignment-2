...
using Gadfly, Compose, ColorSchemes, Distributions, Plots, Statistics
...
# ╔═╡ 6cb46750-5834-11ee-1d2d-d18855b2ae52
text_data = open("DS1.txt")
...
begin 
	...
	p7 = Gadfly.plot(freq_counts[freq_counts."Presence of heart disease" .== "Yes", :], color=:Sex, y=:nrow, x=:Age, alpha=[0.5], Geom.bar(position=:identity),Coord.cartesian(xmin=20, xmax=80, ymin=0, ymax=10),Guide.ylabel("Frequency"))
	p8 = Gadfly.plot(freq_counts[freq_counts."Presence of heart disease" .== "No", :], color=:Sex, y=:nrow, x=:Age, alpha=[0.5], Geom.bar(position=:identity),Coord.cartesian(xmin=20, xmax=80, ymin=0, ymax=10),Guide.ylabel("Frequency"))
	title(hstack(p7,p8), "No Heart Disease Population vs Heart Disease Poulation", Compose.fontsize(18pt), fill(colorant"Blue"))
end

# ╔═╡ d118ba11-3df2-4d31-9f49-586e3b3f9a1c
# seabourne style catbox plot
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "bc95bfd169cbc553eb6a0f5ab8fc990d725db278"
