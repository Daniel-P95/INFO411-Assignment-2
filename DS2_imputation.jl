...
using DelimitedFiles, DataFrames, CategoricalArrays, Missings
...
begin
	...
	imputed_va = Impute.locf(named_va)

end;

# ╔═╡ b4930b62-0433-4da4-a8d0-11709e7118b1
imputed_va

# ╔═╡ 3688ba0d-e6ce-46b8-8770-2612a5647823
named_va
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "91895c78513e600cfe040440824f17013cc39afd"
